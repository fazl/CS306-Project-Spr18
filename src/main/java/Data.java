public class Data {
    ...
    //
    public static final String PROD_IP_ADDRESS_DEFAULT = "127.0.0.1";
    public static final String TEST_IP_ADDRESS_DEFAULT = "127.0.0.1";
    public static final String PROD_SQL_SERVER_TEMP_BAK_DIR_SMB = "smb://127.0.0.1/x$/TempBakDir/";
    public static final String TEST_SQL_SERVER_TEMP_BAK_DIR_SMB = "smb://127.0.0.1/x$/TempBakDir/";
    // For local testing, can override these via VM arguments -DMYPC_HOSTNAME="YOUR PC HOSTNAME HERE" etc
    public static final String MYPC_IP_ADDRESS_DEFAULT = "127.0.0.1";
    public static final String MYPC_HOSTNAME_DEFAULT = "localhost";
    public static final String UNC_PATH_MYPC_DEFAULT = "\\\\"+MYPC_HOSTNAME_DEFAULT+"\\D$\\dest";
    ...
    public static final String SMB_URL_PROD_DEFAULT = "smb://127.0.0.1/x$/MSSQL11.MSSQLSERVER/MSSQL/DATA";
    public static final String SMB_URL_TEST_DEFAULT = "smb://127.0.0.1/x$/MSSQL11.MSSQLSERVER/MSSQL/Data";
